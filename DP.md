...
The way to solve DP Partition problems is :  
       1. Run function for whole array considering it as one of the partition. Have the base case clear in your mind  
       2. Then try out all partitions i.e. run the loop for partition pointer k to try out all partitions  
       3. Then return the best case scenario according to the Question   
